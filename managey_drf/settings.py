...
# Route 500 tracebacks to stderr so Render's log viewer shows them.
# Django's default config silently drops them when DEBUG=False.
LOGGING = {
    'version': 1,
...
MIDDLEWARE = [
    ...
    # SecurityMiddleware so its headers are applied.
