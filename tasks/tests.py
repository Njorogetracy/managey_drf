...
class TaskDetailTests(APITestCase):
    def setUp(self):
       ...
       Task.objects.create(owner=july, title='task title', description='julys task content')
       Task.objects.create(owner=juni, title='task 2 title', description='junis task content')
    ...
    def tearDown(self):
        """
        runs after every test method to ensure each test starts with a clean slate
        """
